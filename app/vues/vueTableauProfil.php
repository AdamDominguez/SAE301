                    ...
                    <div class="recap-profil">
                        <div class="container-profil-photo">
                            <div class="photo-profil" id="photoProfil"
                                style="background-image: url('<?= $urlPhoto ?>'); background-size: cover; background-position: center;">
                                <button class="upload-photo">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="var(--blanc)" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-camera w-5 h-5" aria-hidden="true">
                                        <path
                        ...
                        <form method="post" action="index.php?action=enregMembrePhoto" enctype="multipart/form-data"
                            class="formPhoto">

                            <div class="form_elt">
                                <input type="hidden" name="MAX_FILE_SIZE" value="500000">
                                <input type="file" class="texte" name="photoMembre"
                                    accept="image/jpeg, image/jpg, image/png,  img/webp">
                            </div>
                        ...
                        <div class="container-profil-contact">
                            <div class="element-profil">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="lucide lucide-mail w-4 h-4 text-[#E5B444]"
                                    aria-hidden="true">
                            ...
                            <div class="element-profil">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="var(--jaune)" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-phone w-4 h-4 text-[#E5B444]"
                                    aria-hidden="true">
                                    <path
                            ...
                            <div class="element-profil">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="var(--jaune)" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-map-pin w-4 h-4 text-[#E5B444]"
                                    aria-hidden="true">
                                    <path
                                ...
                                <span><?= $_SESSION['adresse'] ?><br><?= $_SESSION['postal'] ?>
                                    <?= $_SESSION['ville'] ?></span>
                            </div>
                            <div class="element-profil">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="var(--jaune)" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-calendar w-4 h-4 text-[#E5B444]"
                                    aria-hidden="true">
                                    <path d="M8 2v4"></path>
                                    <path d="M16 2v4"></path>
                            ...
                            <div class="container-info-perso">
                                <div class="flex-element info">
                                    <div class="element-info perso">
                                        <label class="prenom" for="firstname">Prénom<span
                                                style="color: var(--jaune);">*</span></label>
                                        <input type="text" id="firstname" name="firstname"
                                            value="<?= $_SESSION['acces'] ?>">
                                    </div>
                                    <div class="element-info perso-2">
                                        <label class="nom" for="lastname">Nom<span
                                                style="color: var(--jaune);">*</span></label>
                                ...
                                <div class="element-info perso-3">
                                    <label class="email" for="email">Email<span
                                            style="color: var(--jaune);">*</span></label>
