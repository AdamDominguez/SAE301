...
<a class='lien' href='index.php?action=commandes'>Commandes</a> <a class='lien' href='index.php?action=quit'>Quitter</a>");
...
// login
define("ACCES_NOM", "adam");
define("ACCES_MDP", "test");

define("UPLOAD_DIR", "photoArticle/");
